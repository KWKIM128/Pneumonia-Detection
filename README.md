...
The dataset contains lung x-ray scans of patients with and without pneumonia. The dataset contains two types of pneumonia, bacterial and viral, as shown in the figure above. However, the model developed only determines whether the x-ray scan has pneumonia or not as shown in figure 2. The developed model can be downloaded at: https://drive.google.com/file/d/1y_PIDx3YNFA6bvyAPnRkv__ZBUd-LrZa/view?usp=sharing 
